...
//  (null)
//
//  Created by Jordan Guggenheim on 6/30/15.
...
+ (void)drawCanvas2
{
    ...
    UIColor* blue = [UIColor colorWithRed: 0.153 green: 0.565 blue: 0.69 alpha: 1];
    UIColor* midnight = [UIColor colorWithRed: 0 green: 0 blue: 0.039 alpha: 1];

    //// Gradient Declarations
    CGFloat gradientLocations[] = {0, 0.2, 0.5, 0.61, 0.87, 1};
    CGGradientRef gradient = CGGradientCreateWithColors(colorSpace, (__bridge CFArrayRef)@[(id)green.CGColor, (id)[green blendedColorWithFraction: 0.5 ofColor: blue].CGColor, (id)blue.CGColor, (id)[blue blendedColorWithFraction: 0.5 ofColor: UIColor.blackColor].CGColor, (id)UIColor.blackColor.CGColor, (id)midnight.CGColor], gradientLocations);

    //// backgroundGradient Drawing
    UIBezierPath* backgroundGradientPath = [UIBezierPath bezierPathWithRect: CGRectMake(0, 0, 414, 1472)];
    CGContextSaveGState(context);
    [backgroundGradientPath addClip];
    CGContextDrawLinearGradient(context, gradient, CGPointMake(207, 1472), CGPointMake(207, -0), 0);
    CGContextRestoreGState(context);
